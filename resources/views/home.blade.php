    ...
    @section('hero')
        <div class="w-full py-32 text-center">
            <h1 class="text-2xl font-bold text-center text-gray-700 md:text-3xl lg:text-5xl">
                Welcome to <span class="text-yellow-500">&lt;GeekGoose&gt;</span> <span class="text-gray-900"> Blog!</span>
            </h1>
            <p class="mt-1 text-lg text-gray-500">Code like a pro, honk like a goose, and have fun along the way!</p>
